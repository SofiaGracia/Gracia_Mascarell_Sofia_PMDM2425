...
El `build.grade.kts` té alies als plugins que utilitza la aplicació, estos plugins están definits en el fitxer `libs.versions.toml` que està a dins del directori **gradle**.
