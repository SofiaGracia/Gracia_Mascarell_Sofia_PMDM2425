...
### Fases del cicle de vida de l'activitat principal i implementació de mètodes de la classe Log
...
i gestionar mitjançant funcions de callback. Incorporarem mètodes de la classe **Log** per veure el funcionament d'aquestos esdeveniments de vida al fitxer **Logcat**:
...
mètode és on generalment utilitzem `setContentView()`.
    <p align="center">
        <img src="" alt="Imatge 10" width="900"/>
    </p>
